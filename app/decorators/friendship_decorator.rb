class FriendshipDecorator < Draper::Decorator
  ...
  def confirm_button
    h.content_tag(:div, class:"col-xs-6") do
  	 h.link_to "Aceptar", h.friendship_path(object,status: 1),method: :patch, class:"btn btn-primary"
    end
  end

  def denegate_button
    h.content_tag(:div, class:"col-xs-6") do
  	 h.link_to "Rechazar", h.friendship_path(object),remote: true ,method: :delete, class:"btn btn-outline-danger"
    end
  end
